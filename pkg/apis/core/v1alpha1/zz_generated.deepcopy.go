...
func (in *ManifestSpec) DeepCopyInto(out *ManifestSpec) {
	*out = *in
	if in.NestedAttchment != nil {
		in, out := &in.NestedAttchment, &out.NestedAttchment
		*out = new(NestedAttachment)
		**out = **in
	}
	return
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NestedAttachment) DeepCopyInto(out *NestedAttachment) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NestedAttachment.
func (in *NestedAttachment) DeepCopy() *NestedAttachment {
	if in == nil {
		return nil
	}
	out := new(NestedAttachment)
